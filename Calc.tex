...
\item
  ...
  \tightlist
  \item
    M: Fundamental Theorem of Calculus. Read
    ...
    \end{itemize}
  \item
    W: Integratin by parts and Substitution. Read

    \begin{itemize}
    \tightlist
    \item
      Stewart, Chapter 7.1 (available on canvas)
    \item
      HW: Stewart 7.1: 1 - 54
    \item
...
\item
  ...
  \tightlist
  \item
    Determining Volumes by Slicing and Volumes of Revolution: Cylindrical Shells. Read
