...
\textbf{Lectures:} W-F, 4:45pm - 6:15pm, CR1
...
\item
  ...
  \tightlist
  \item
    M: General discussion \& Review of functions. Read \href{https://openstax.org/books/calculus-volume-1/pages/1-introduction}{Vol.1, Chapter 1}.
  \item
    W: Preview of Calculus, Introduction to limits. Read \href{https://openstax.org/books/calculus-volume-1/pages/2-1-a-preview-of-calculus}{Vol.1, 2.1, 2.2}
  \end{itemize}
\item
  Week 2:
\end{itemize}
